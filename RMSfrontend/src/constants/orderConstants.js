...
export const DELETE_ORDER_ITEM_REQUEST_SUCCESS =
  "DELETE_ORDER_ITEM_REQUEST_SUCCESS";
export const DELETE_ORDER_ITEM_REQUEST_FAILURE =
  "DELETE_ORDER_ITEM_REQUEST_FAILURE";

export const UPDATE_ORDER_DISCOUNT_REQUEST = "UPDATE_ORDER_DISCOUNT_REQUEST";
export const UPDATE_ORDER_DISCOUNT_REQUEST_FAILURE =
  "UPDATE_ORDER_DISCOUNT_REQUEST_FAILURE";
export const UPDATE_ORDER_DISCOUNT_REQUEST_SUCCESS =
  "UPDATE_ORDER_DISCOUNT_REQUEST_SUCCESS";

export const UPDATE_ORDER_DELIVERY_CHARGES_REQUEST =
  "UPDATE_ORDER_DELIVERY_CHARGES_REQUEST";
export const UPDATE_ORDER_DELIVERY_CHARGES_REQUEST_FAILURE =
  "UPDATE_ORDER_DELIVERY_CHARGES_REQUEST_FAILURE";
export const UPDATE_ORDER_DELIVERY_CHARGES_REQUEST_SUCCESS =
  "UPDATE_ORDER_DELIVERY_CHARGES_REQUEST_SUCCESS";

export const UPDATE_ORDER_PAYMENT_REQUEST = "UPDATE_ORDER_PAYMENT_REQUEST";
export const UPDATE_ORDER_PAYMENT_REQUEST_SUCCESS =
  "UPDATE_ORDER_PAYMENT_REQUEST_SUCCESS";
export const UPDATE_ORDER_PAYMENT_REQUEST_FAILURE =
